# 9. A restaurant has a list of menu items and their prices. The restaurant owner wants to print the menu to the console, 
# along with the price of each item, and then calculate the total cost of a customer's order. 
# Write a Ruby program to solve this problem. 
